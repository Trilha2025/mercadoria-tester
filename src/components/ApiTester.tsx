...
const ApiTester = () => {
  ...
  const handleAuth = async () => {
    try {
      ...
      const authUrl = `https://auth.mercadolivre.com.br/authorization?response_type=code&client_id=${import.meta.env.VITE_ML_CLIENT_ID}&redirect_uri=https://atrilhadoecommerce.lovable.dev/ml-callback&code_challenge_method=S256&code_challenge=${challenge}`;
